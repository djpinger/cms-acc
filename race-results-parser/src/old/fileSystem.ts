...
import fs from 'fs';
import { RawRaceOrQualifyResult, SeasonConfig, CarConfig } from './models';
...
export function saveResults(data: any): void {
  const filepath = path.join(__dirname, '../', 'final', 'results.json');
